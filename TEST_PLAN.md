...
| 编号 | 测试项 | 操作 | 预期 |
|------|------|------|------|
| T01 | 记事本按着说闭环 | 打开记事本，放好光标，按住默认 `右 Ctrl` 说一句，松开 | 识别文本自动插入记事本，不需要点击悬浮窗“插入”；悬浮窗在松开后自动收起 |
