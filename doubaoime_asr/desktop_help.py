...
悬浮窗有两种状态：待说话时显示蓝色麦克风图和“点击/长按说话”，录音中显示蓝色声波条和“点击结束语音输入”。
悬浮窗中间是识别结果框，实时识别和最终文本会显示在框内，底部有“清空”“复制”“插入”三个操作。
...
7. 程序闪退或录音后无响应：
   请打开 %APPDATA%\\DoubaoASRHelper\\logs，查看当天的 client-YYYYMMDD.log 和 asr_bridge-YYYYMMDD.log。前者记录主界面、热键和插入流程；后者记录录音后端和 ASR 错误。
